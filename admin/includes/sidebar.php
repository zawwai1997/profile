...
<a href="summary.php" class="list-group-item list-group-item-action bg-light">Summary</a>
<a href="pui-state.php" class="list-group-item list-group-item-action bg-light">PUI(States)</a>
<a href="daily-chart.php" class="list-group-item list-group-item-action bg-light">Daily Chart</a>
