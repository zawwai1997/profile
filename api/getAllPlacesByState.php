...
foreach ($data as $key => $value) {
    ...
    if(!isset($stateAry[$value['state']])) {
        $stateAry[$value['state']] = array();
    }

    $stateAry[$value['state']][] = $OneHospitalAry;
}
$overall = array(
    "total_pui" => $total_pui,
...
$finalAry = array("overall" => $overall, "details" => $stateAry);
