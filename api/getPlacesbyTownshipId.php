...
if(!isset($_GET['id']) or !is_numeric($_GET['id']) or $_GET['id']>483 or $_GET['id']<1){
    $finalAry = "ID is invalid";
}else {

    $township_id = $user->checkInput($_GET['id']);
    $data = $user->getAllBy('Townships.id = '.$township_id,"Hospitals.name");
